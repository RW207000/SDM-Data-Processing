...
write.csv(participantsnoduplicates, file = "Data/3 Cleaned data/Feb 25/participantsnoduplicatesFeb25_before_CaHASE2.csv", row.names = F, na = "")

# medication_clean
write.csv(medication_clean, file = "Data/3 Cleaned data/Feb 25/medication_cleanFeb25_before_CaHASE2.csv", row.names = F, na = "")

# meds_wide
write.csv(meds_wide, file = "Data/3 Cleaned data/Feb 25/meds_wideFeb25_before_CaHASE2.csv", row.names = F, na = "")

# CAH biomarkers
# CAH_biomarkers <- CAH_biomarkers[CAH_biomarkers$Date >= '2022-12-01',]
write.csv(CAH_biomarkers, file = "Data/3 Cleaned data/Feb 25/CAH_biomarkers_before_CaHASE2.csv", row.names = F, na = "")

# labs_wide
labs_wide_export <- labs_wide
# labs_wide_export <- labs_wide_export[labs_wide_export$Date >= '2022-12-01',]
write.csv(labs_wide_export, file = "Data/3 Cleaned data/Feb 25/labs_wideFeb25_before_CaHASE2.csv", row.names = F, na = "")
```
...
write.csv(all_data, file = "Outputs/all_data_before_CaHASE2.csv", row.names = F, na = "")
```
