...
write.csv(participantsnoduplicates, file = "Data/3 Cleaned data/Feb 25/participantsnoduplicatesFeb25.csv", row.names = F)

# medication_clean
write.csv(medication_clean, file = "Data/3 Cleaned data/Feb 25/medication_cleanFeb25.csv", row.names = F)

# meds_wide
write.csv(meds_wide, file = "Data/3 Cleaned data/Feb 25/meds_wideFeb25.csv", row.names = F)

# labs_wide
write.csv(labs_wide, file = "Data/3 Cleaned data/Feb 25/labs_wideFeb25.csv", row.names = F)
```
