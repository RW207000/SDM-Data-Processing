...
```{r : reading in data}
participants_all <- read.csv("Data/1 Registry extracts/Feb 25 Extract/Longitudinal data 24.02.2025.csv",header=T, na.strings="")
...
labs_all <- read.csv("Data/1 Registry extracts/Feb 25 Extract/Labs data 24.02.2025.csv", header=T, na.strings= c("", "NA"))
...
write.csv(participantsnoduplicates, file = "Data/3 Cleaned data/Feb 25/participantsnoduplicatesFeb25.csv", row.names = F, na = "")

# medication_clean
write.csv(medication_clean, file = "Data/3 Cleaned data/Feb 25/medication_cleanFeb25.csv", row.names = F, na = "")

# meds_wide
write.csv(meds_wide, file = "Data/3 Cleaned data/Feb 25/meds_wideFeb25.csv", row.names = F, na = "")

# CAH biomarkers
CAH_biomarkers <- CAH_biomarkers[CAH_biomarkers$Date >= '2022-12-01',]
write.csv(CAH_biomarkers, file = "Data/3 Cleaned data/Feb 25/CAH_biomarkers.csv", row.names = F, na = "")

# labs_wide
labs_wide_export <- labs_wide
labs_wide_export <- labs_wide_export[labs_wide_export$Date >= '2022-12-01',]
write.csv(labs_wide_export, file = "Data/3 Cleaned data/Feb 25/labs_wideFeb25.csv", row.names = F, na = "")
```
