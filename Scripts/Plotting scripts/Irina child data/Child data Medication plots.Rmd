...
# using MDBoxPlot function
HCe_total_daily_doses <- MDBoxPlot(single_therapy, "total_daily_HCeq_dose", "None", "HC total daily dose")
...
HCe_total_daily_doses_per_BSA <- MDBoxPlot(single_therapy, "HCe.total.daily.dose.per.BSA", "None", "Total daily HCe / m2")

HCe_total_daily_doses_per_BSA_violin <- ggplot(single_therapy, aes(x = Centre.ID.x, y = HCe.total.daily.dose.per.BSA, fill = Centre.ID.x)) + geom_violin() +
  theme_classic() +
  stat_summary(fun = "mean",
               geom = "point",
               color = "black")
